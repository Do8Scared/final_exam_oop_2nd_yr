...
const TOP_DISHES = MENU.filter((m) => m.tag === "Best Seller" || m.tag === "Popular").slice(0, 6);
const FEATURED_HERO = MENU[22]; // Unagi Don as hero
    ...
    <div className="min-h-screen" style={{ background: "#111110", fontFamily: "'Inter', sans-serif" }}>
      ...
      <section className="relative overflow-hidden flex items-end" style={{ height: "90vh", paddingTop: "64px" }}>
        <div className="absolute inset-0">
          <img src={FEATURED_HERO.image} alt="Kaisendon hero" className="w-full h-full object-cover" />
