...
public class MenuDAO {
    ...
    /**
     * Retrieves all active menu items and returns them as a List of MenuItem objects.
     * This is designed for the Spring Boot REST API.
     *
     * @return a list of MenuItem objects
     */
    public static List<MenuItem> getAllMenuItemsAsList() {
        List<MenuItem> items = new ArrayList<>();
        String sql = "SELECT id, item_name, price, stock_quantity, category, special_attribute FROM menu_items WHERE is_active = TRUE ORDER BY id ASC";
